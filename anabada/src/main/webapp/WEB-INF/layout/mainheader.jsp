		...
		<nav class="navbar navbar-light bg-white navbar-expand-xl">
			...
			<div class="collapse navbar-collapse bg-white" id="navbarCollapse">
				<div class="navbar-nav mx-auto">
					...
					<a href="item.do" class="nav-item nav-link">상품</a>
					...
					<a href="addItemForm.do" class="nav-item nav-link">상품등록</a>
				</div>
				<div class="d-flex m-3 me-0">
					...
					<a href="loginForm.do" class="position-relative me-4 my-auto">
						<i class="fas fa-user fa-2x"></i> <span></span>
					</a>
						<a href="signUpForm.do" class="position-relative me-4 my-auto"> 
						<i class="fas fa-solid fa-user-plus fa-2x"></i> <span></span>
					</a>
					<a href="diaryForm.do" class="my-auto"> 
						<i class="fas fa-regular fa-calendar fa-2x"></i> <span></span>
					</a>
				</div>
			</div>
		</nav>
